    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-stone-500">Review and manage incoming manuscripts.</p>
            </div>
                                    ...
                                    <TableCell className="text-right">
                                        <div className="flex justify-end gap-2">
                                            <Button
                                                ...
                                                onClick={() => updateStatus({ submissionId: sub._id, status: "accepted" })}
                                            >
                                            ...
                                            <Button
                                                ...
                                                onClick={() => updateStatus({ submissionId: sub._id, status: "rejected" })}
                                            >
