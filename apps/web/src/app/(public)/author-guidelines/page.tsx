    ...
    return (
        <div className="container mx-auto px-4 py-16 max-w-4xl">
            ...
            <p className="text-xl text-stone-600 mb-10 leading-relaxed">
                Authors are invited to submit original research articles, reviews, and case studies relevant to the journal’s scope.
            ...
            <div className="space-y-12">
                <section>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div className="bg-stone-50 p-6 rounded-lg">
                            <h3 className="font-bold text-lg mb-2">Review Articles</h3>
                ...
                <section>
                    <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">Manuscript Preparation</h2>
                ...
                <section>
                    ...
                    <p className="text-stone-700 mb-4">
                        Manuscripts reporting studies involving human participants must include a statement regarding Ethics Committee approval and informed consent.
